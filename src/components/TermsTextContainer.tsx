...
function TermsTextContainer(props: TextContainerProps) {
    ...
    >
      ...
      >
        ...
        >
          ...
          conditions. Do not continue to use ample.stream if you do not agree to
          ...
          License
          <br />
          Unless otherwise stated, Ample LLC and/or its licensors own the
          intellectual property rights for all material on ample.stream. All
          intellectual property rights are reserved. You may access this from
          ample.stream for your own personal use subjected to restrictions set
          ...
          <br />
          <br />
          Republish material from ample.stream
          <br />
          Sell, rent or sub-license material from ample.stream
          <br />
          Reproduce, duplicate or copy material from ample.stream
          <br />
          Redistribute content from ample.stream
          <br />
          ...
          Ample LLC does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Ample LLC,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Ample LLC shall
          not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website.
          <br />
          <br />
          Ample LLC reserves the right to monitor all Comments and to remove any
          ...
          <br />
          You hereby grant Ample LLC a non-exclusive license to use, reproduce,
          ...
          the hyperlink compensates the absence of Ample LLC; and (d) the link
          ...
          sending an e-mail to Ample LLC. Please include your name, your
...
export default TermsTextContainer;
